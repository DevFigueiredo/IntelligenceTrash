...
array(
	"CNS" => "35583629851", 
                ...
                "IdVacinador" => "ADRIANO FERNADES GACALLI",    
...
array(        
                ...
                "CodigoSexo" => "F", 
                "DataNascimento" => "04/06/1945",
                "NumeroTelefone" => "12997725647",
                "LogradouroResidencia" => "RUA BENEDITA JOSÉ BARBOSA",
                "NumeroLogradouroResidencia" => "155",
                "Bairro" => "RIO DO OURO",
                "ComplementoLogradouroResidencia" => "",
                "Email" => "",
                "IdGrupoAtendimento" => "IDOSO", 
...
array(        
                ...
                "CodigoSexo" => "F", 
                "DataNascimento" => "04/06/1945",
                "NumeroTelefone" => "129976006996",
                "LogradouroResidencia" => "RUA JOSE ANTONIO SOUZA CASTRO RODRIGUES",
                "NumeroLogradouroResidencia" => "675",
                "Bairro" => "RIO DO OURO",
                "ComplementoLogradouroResidencia" => "",
                "Email" => "",
...
array(        
                ...
                "CodigoSexo" => "M", 
                "DataNascimento" => "04/06/1945",
                "NumeroTelefone" => "12997930835",
                "LogradouroResidencia" => "RUA BENEDITO DE CARVALHO",
                "NumeroLogradouroResidencia" => "695",
                "Bairro" => "RIO DO OURO",
                "ComplementoLogradouroResidencia" => "",
                "Email" => "",
                "IdGrupoAtendimento" => "IDOSO", 
